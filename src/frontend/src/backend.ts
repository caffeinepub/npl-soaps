...
export class Backend implements backendInterface {
    ...
    async getContactSubmissionsAdmin(): Promise<Array<ContactSubmissionAdmin>> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [Array<_Product>]): Array<Product> | null {
